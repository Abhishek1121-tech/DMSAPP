...
public interface IBillingDao extends JpaRepository<Billing, Long> {
	...
	@Query("select new com.inn.dms.report.wrapper.SalesmansalesWrapper(item,cust.salesman.id) from Billing item left join item.customer cust join cust.salesman ")
